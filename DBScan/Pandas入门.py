...
filepath = r'D:\WorkSpace\PythonHome\MachineLearningAndDeepLearning\DBScan\hotpic\test.csv'
...
# series 和 DataFrame 是 Pandas中最常用的两个对象
...
# 某行所有列
print(data.ix[0, :])  # #第一行所有数据  ix(index 缩写 )

# 某几行-所有列
print(data.ix[[0, 2],])  # 获取第1/3行的数据
